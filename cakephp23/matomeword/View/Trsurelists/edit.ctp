<div class="trsurelists form">
<?php echo $this->Form->create('Trsurelist'); ?>
	<fieldset>
		<legend><?php echo __('Edit Trsurelist'); ?></legend>
	<?php
		echo $this->Form->input('id');
		echo $this->Form->input('Url');
		echo $this->Form->input('honbun1');
		echo $this->Form->input('cate1', array('type' => 'select', 'options' => $Mskatelist,  'label' => false)); 
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Trsurelist.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Trsurelist.id'))); ?></li>
		<li><?php echo $this->Html->link(__('List Trsurelists'), array('action' => 'index')); ?></li>
	</ul>
</div>
