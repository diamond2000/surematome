<div class="trsuredata form">
<?php echo $this->Form->create('Trsuredatum'); ?>
	<fieldset>
		<legend><?php echo __('Edit Trsuredatum'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Trsuredatum.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Trsuredatum.id'))); ?></li>
		<li><?php echo $this->Html->link(__('List Trsuredata'), array('action' => 'index')); ?></li>
	</ul>
</div>
