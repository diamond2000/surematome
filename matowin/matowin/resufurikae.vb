        ...
        Try
            ...
            For i As Integer = 0 To lbody.Count - 1
                If Rnd() * 100000 Mod 2 >= 1 Then
                    ...
                    If Rnd() * 100000 Mod 2 >= 1 Then
                        'red
                        lbody(i) = lstrBun.Substring(0, lintkaisiColor + 1) & "<font color=red  size=3>" & lstrBun.Substring(lintkaisiColor + 2, lstrBun.Length - lintkaisiColor - 2) & "</font>"
                    Else
                        'blue
                        lbody(i) = lstrBun.Substring(0, lintkaisiColor + 1) & "<font color=blue size=3>" & lstrBun.Substring(lintkaisiColor + 2, lstrBun.Length - lintkaisiColor - 2) & "</font>"
                    End If
